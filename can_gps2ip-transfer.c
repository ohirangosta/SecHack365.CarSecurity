 ...
 *
 * usage:
 * 1)  ./can2ip-transfer			 : Analaze and Send Honda Alphard can packet(s) info
 * 2)  ./can2ip-transfer			 : Analaze and Send Corolla Fielder can packet(s) info
 * 3)  ./can2ip-transfer			 : Analaze and Send Toyota Aqua can packet(s) info
